            ...
            <div className={isActive ? "container active" : "container"}>
                ...
                <ul className="header__list">
                    <li className="header__item">
                        <Link className={currentRoute === "/api" ? "header__link active disabled" : "header__link disabled"} href="#" title="Coming Soon in Summer 2023">
                            API
                        </Link>
                    </li>
                    <li className="header__item">
                        <Link className={currentRoute === "/docs" ? "header__link active disabled" : "header__link disabled"} href="#" title="Coming Soon in Summer 2023">
                            Docs
                        </Link>
                    </li>
                    <li className="header__item">
                        <Link className={currentRoute === "/changelog" ? "header__link active" : "header__link"} href="/changelog">
                            Changelog
                        </Link>
                    </li>
                    <li className="header__item">
                        <Link className='header__link' href="mailto:whois@weekendlabs.net?subject=WHOIS">
                            Support
                        </Link>
                    </li>
                </ul>
